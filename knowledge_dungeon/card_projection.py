...
from .contracts import CARD_FRESHNESS_BY_LIFECYCLE, CardDefinition, LearningSnapshot, VersionBundle

FULL_MULTIPLIER_BP = CARD_FRESHNESS_BY_LIFECYCLE["active"]
ACTIVE_MULTIPLIER_BP = CARD_FRESHNESS_BY_LIFECYCLE["active"]
FADING_LIGHT_MULTIPLIER_BP = CARD_FRESHNESS_BY_LIFECYCLE["fading_light"]
FADING_HEAVY_MULTIPLIER_BP = CARD_FRESHNESS_BY_LIFECYCLE["fading_heavy"]
