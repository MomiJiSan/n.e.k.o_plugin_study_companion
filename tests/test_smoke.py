...
def test_both_knowledge_map_uis_localize_internal_edge_values() -> None:
    ...
    assert "./style.css?v=practice-difficulty-selector-20260907" in static_index
    assert "./knowledge-map.js?v=study-related-topics-20260903" in static_index
...
def test_release_versions_stay_in_sync() -> None:
    ...
    assert plugin_version == project_version == locked_version == "0.2.6"
